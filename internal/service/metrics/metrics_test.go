...
// This is no longer needed since we're using the actual AuditPublisher
// type mockAuditPublisher struct {
// 	observers []audit.AuditObserver
// }

// func (m *mockAuditPublisher) Publish(event models.AuditEvent) {
// 	for _, obs := range m.observers {
// 		_ = obs.Notify(event)
// 	}
// }

// func (m *mockAuditPublisher) Register(o audit.AuditObserver) {
